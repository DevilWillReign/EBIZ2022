...
describe("about component test", () => {
    beforeEach(() => {
        cy.visit(Cypress.env("front_url") + "/about")
    })
    ...
    it("display about accordion first header element", () => {
        ...
        cy.get("#about .accordion-item .accordion-header").first().should("exist")
        cy.get("#about .accordion-item .accordion-header button").first().should("exist")
        cy.get("#about .accordion-item .accordion-header button").first().should("have.text", "Accordion Item #1")
    })
